          ...
          <div className="border-t border-nature-green-200 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex space-x-6 mb-4 md:mb-0">
                <a href="https://vk.com/kamenberegelovoe" target="_blank" rel="noopener noreferrer" className="text-nature-green-300 hover:text-white transition-colors transform hover:scale-110 duration-200" aria-label="VKontakte">
                ...
                <a href="https://t.me/kamenniy_bereg" target="_blank" rel="noopener noreferrer" className="text-nature-green-300 hover:text-white transition-colors transform hover:scale-110 duration-200" aria-label="Telegram">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
